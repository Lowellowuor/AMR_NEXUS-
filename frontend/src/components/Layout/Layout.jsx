...
export default function Layout({ role, onToggleRole, darkMode, onToggleDark }) {
  ...
  return (
    <div className="min-h-screen bg-[var(--bg-tertiary)] flex flex-col">
      <div
      ...
      >
        ...
        <div
          ref={sidebarRef}
          className={`relative flex flex-col w-64 bg-[var(--bg-secondary)] h-full shadow-2xl transform transition-transform duration-300 ease-in-out ${
        ...
        >
          <div className="flex items-center justify-between p-4 border-b border-[var(--border-primary)]">
            ...
            <button
              ...
              className="text-[var(--text-muted)] hover:text-[var(--text-secondary)] focus:outline-none focus:ring-2 focus:ring-teal-500 rounded"
      ...
      <div className="hidden lg:fixed lg:inset-y-0 lg:flex lg:items-center lg:justify-center lg:pointer-events-none">
        <div className="lg:relative lg:w-64 lg:mx-6 lg:my-8 lg:pointer-events-auto">
          <div className="flex flex-col bg-[var(--bg-secondary)]/90 backdrop-blur-xl rounded-2xl shadow-xl border border-[var(--border-primary)] overflow-hidden">
            <div className="pt-6 pb-2 px-4 border-b border-[var(--border-primary)]">
              <div className="flex items-center gap-2">
