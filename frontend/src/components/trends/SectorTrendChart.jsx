...
const sectorColors = {
  human: 'var(--accent-teal)',
  poultry: 'var(--status-warning)',
  environment: 'var(--status-success)',
};
...
export default function SectorTrendChart({ months = 12 }) {
  ...
  if (error) {
    return (
      <div className="card p-5 text-center text-[var(--status-critical)] flex items-center justify-center gap-2">
