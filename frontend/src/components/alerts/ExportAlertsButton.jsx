...
export default function ExportAlertsButton({
  ...
  return (
    <button
      ...
      disabled={loading}
      className="flex items-center gap-2 px-4 py-2 bg-[var(--accent-teal)] text-white rounded-full text-sm font-medium hover:bg-[var(--accent-teal)] transition disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary-500"
    >
      {loading ? (
        <>
