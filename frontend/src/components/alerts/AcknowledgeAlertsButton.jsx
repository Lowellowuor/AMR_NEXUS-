...
export default function AcknowledgeAlertsButton({
  ...
  if (loading) {
    return (
      <button
        disabled
        className="px-4 py-2 border border-[var(--border-secondary)] rounded-full text-sm font-medium flex items-center gap-2 opacity-50 cursor-not-allowed"
      >
  ...
  if (error) {
    return (
      <button
        onClick={fetchAlerts}
        className="px-4 py-2 border border-red-300 rounded-full text-sm font-medium flex items-center gap-2 text-[var(--status-critical)] hover:bg-[var(--status-critical-bg)] transition"
      >
  ...
  return (
    <button
      ...
      disabled={processing}
      className={`px-4 py-2 border border-[var(--border-secondary)] rounded-full text-sm font-medium flex items-center gap-2 hover:bg-[var(--bg-secondary)]/60 transition ${
