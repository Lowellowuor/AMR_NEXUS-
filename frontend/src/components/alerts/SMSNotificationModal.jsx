...
export default function SMSNotificationModal() {
  ...
  return (
    <div className="fixed inset-0 z-[300] flex items-center justify-center p-4">
      ...
      <div className="relative bg-[var(--bg-secondary)]/90 backdrop-blur-sm rounded-2xl shadow-xl border border-white/50 max-w-md w-full p-6">
        <button
        ...
        <div className="flex items-center gap-3 mb-5">
          ...
          <div>
            ...
            <p className="text-xs text-[var(--text-muted)]">Africaâ€™s Talking</p>
          </div>
        </div>
        ...
        {error && (
          <div className="p-2 mb-3 rounded-lg bg-[var(--status-critical-bg)] text-[var(--status-critical)] text-xs">
            {error}
          </div>
        )}
