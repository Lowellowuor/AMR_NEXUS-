  ...
  return (
    <div className="bg-[var(--bg-secondary)]/80 backdrop-blur-sm rounded-2xl shadow-md border border-white/50 p-5">
      <div className="flex justify-between items-center mb-2">
        <h3 className="text-md font-semibold text-[var(--text-primary)]">MDR Trend (with forecast)</h3>
      ...
      <ResponsiveContainer width="100%" height={300}>
        <LineChart data={combinedData}>
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="rate" stroke="var(--accent-blue)" strokeWidth={2} name="MDR Rate (%)" />
