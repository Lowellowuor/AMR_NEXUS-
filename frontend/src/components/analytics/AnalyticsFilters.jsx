...
export default function AnalyticsFilters({
  ...
  return (
    <div className="bg-[var(--bg-secondary)]/80 backdrop-blur-sm rounded-2xl shadow-md border border-white/50 p-5 space-y-4">
      <div className="flex items-center justify-between">
        ...
        {activeFilterCount > 0 && (
          <button
            onClick={handleReset}
            className="text-xs text-[var(--text-muted)] hover:text-[var(--status-critical)] transition-colors flex items-center gap-1"
          >
      ...
      <div className="grid grid-cols-1 md:grid-cols-6 gap-3">
        <div>
          ...
          <input
            ...
            className="w-full rounded-full border border-[var(--border-secondary)] px-3 py-1.5 text-sm focus:ring-2 focus:ring-primary-500 focus:border-[var(--accent-teal)] bg-[var(--bg-secondary)]"
          />
        </div>
        ...
        <div>
          <label className="block text-xs text-[var(--text-muted)] mb-1">Pathogen</label>
          <Select
        ...
        <div className="flex items-end">
          <label className="flex items-center gap-2 text-sm text-[var(--text-secondary)]">
            <input
              ...
              className="rounded border-[var(--border-secondary)] text-[var(--accent-teal)] focus:ring-primary-500"
            />
            Auto-refresh (30s)
          </label>
        </div>
        ...
        <div className="flex items-end gap-2">
          <button
            onClick={onRefresh}
            disabled={loading}
            className="flex-1 flex items-center justify-center gap-2 px-4 py-1.5 bg-[var(--accent-teal)] text-white rounded-full text-sm hover:bg-[var(--accent-teal)] transition disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-primary-500"
          >
