      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div>
          ...
          <select
            ...
            className="w-full rounded-full border border-[var(--border-primary)] bg-[var(--bg-tertiary)]/50 px-4 py-2 text-sm focus:ring-2 focus:ring-primary-500/20"
          >
            ...
            <option value="pathogen_wise">Pathogenâ€‘wise Resistance</option>
        ...
        <div className="flex items-end">
          <button
            onClick={onRefresh}
            className="flex items-center justify-center gap-2 w-full px-4 py-2 bg-primary-50 text-[var(--accent-teal)] rounded-full text-sm font-medium hover:bg-primary-100 transition"
          >
