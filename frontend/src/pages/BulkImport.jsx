...
export default function BulkImport() {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-[var(--bg-secondary)]/80 backdrop-blur-sm rounded-2xl p-6">
        ...
        {preview.length > 0 && (
          <>
            ...
            <button onClick={handleImport} disabled={importing} className="mt-4 px-4 py-2 bg-[var(--accent-teal)] text-white rounded-full">Import {preview.length} records</button>
          </>
        )}
      </div>
    </div>
