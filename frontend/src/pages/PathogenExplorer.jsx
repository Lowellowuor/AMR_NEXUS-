...
import { getPathogenList, getPathogenDetail } from '../api/endpoints';
      ...
      {!filters.pathogen ? (
        ...
        <>
          ...
          <div>
            ...
            {filters.tab === 'geography' && <PathogenGeographyTab data={data} onCountyClick={(county) => update({ county, tab: 'overview' })} />}
