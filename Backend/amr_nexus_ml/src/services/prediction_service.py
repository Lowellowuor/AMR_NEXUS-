...
class PredictionService:
    ...
    async def predict(
        ...
        X = get_preprocessor().transform(df)
        ...
        X_numeric = X_arr[:, get_numeric_indices()]
        ...
        db_record = AMRIsolateRecord(
            ...
            prior_antibiotic_exposure=bool(input_dict.get("prior_antibiotic_exposure", False)) if input_dict.get("prior_antibiotic_exposure") is not None else None,
