          ...
          <>
            ...
            <div className="p-6 border-b border-[var(--border-primary)]">
              ...
              <div className="flex items-start gap-4 mb-4">
                <div className={`w-11 h-11 rounded-xl flex items-center justify-center ${isCritical ? 'bg-red-500/10' : isHigh ? 'bg-red-500/10' : 'bg-cyan-500/10'}`}>
            ...
            {explanation && (
              <div className="p-6 border-b border-[var(--border-primary)]">
                ...
                <div className={`p-4 rounded-xl border mb-4 ${isCritical || isHigh ? 'bg-red-500/5 border-red-500/20' : 'bg-cyan-500/5 border-cyan-500/20'}`}>
                      ...
                      {explanation.contributors.map((c, idx) => (
                        <div key={idx}>
                          ...
                          <div className="h-2 bg-[var(--bg-tertiary)] rounded-full overflow-hidden">
                            <div
                              className={`h-full rounded-full ${c.direction === 'increases risk' ? 'bg-red-500' : 'bg-emerald-500'}`}
