...
const PredictionForm = forwardRef(({ onSubmit, isLoading, onFormChange }, ref) => {
  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-md border border-slate-200 p-6">
      <h2 className="text-xl font-semibold text-slate-900 mb-4">New AMR Prediction</h2>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
        <div className="max-h-[60vh] overflow-y-auto pr-2 space-y-5">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Pathogen *</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Antibiotic Class *</label>
            ...
            <div>
              <label className="block text-sm font-semibold text-slate-700 mb-1">Test Method *</label>
          ...
          {showAdvanced && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-2 border-t border-slate-200">
              <label className="flex items-center gap-2"><input type="checkbox" {...register('prior_antibiotic_exposure')} className="rounded border-slate-300" /><span className="text-sm text-slate-800">Prior antibiotic exposure (30d)</span></label>
